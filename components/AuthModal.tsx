  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const timeoutPromise = new Promise((_, reject) =>
        setTimeout(() => reject(new Error('Request timeout - please check your internet connection or try again')), 15000)
      );
      ...
      if (mode === 'login') {
        ...
        await Promise.race([resetPasswordForEmail(email), timeoutPromise]);
